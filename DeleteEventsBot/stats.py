from DeleteEventsBot.database.users_sql import Users, num_users
from DeleteEventsBot.database.chats_sql import Chats, num_chats
from DeleteEventsBot.database import SESSION
